...
import { UI } from "./uiPaneMainClass.js";
...
// let uiStateStack = ["GAME_META","GAME_PLAY"];  // Stack starts with gameplay as the default state

// // Function to get the current UI state
// function getCurrentUIState() {
//     return uiStateStack.length > 0 ? uiStateStack[uiStateStack.length - 1] : "GAME_PLAY";
// }
